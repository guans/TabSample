...
public void  isGpsOpen(){
    ...
    //弹出对话框
    new AlertDialog.Builder(GetLocationActivity.this).setMessage(""+status).setPositiveButton("OK", null).show();
    //弹出Toast
    Toast.makeText(GetLocationActivity.this, status, Toast.LENGTH_LONG).show();
...
private void initGPS(){ 
    ...
    if(!locationManager.isProviderEnabled(android.location.LocationManager.GPS_PROVIDER)){ 
     Toast.makeText(GetLocationActivity.this, "GPS 定位没有开启,请打开!", Toast.LENGTH_SHORT).show(); 
     //转到手机设置界面，用户设置GPS
     ...
     startActivityForResult(intent,0); //设置完成后返回到原来的界面
      ...
      //弹出Toast
     Toast.makeText(GetLocationActivity.this, "GPS 已经开启", Toast.LENGTH_LONG).show(); 
      //弹出对话框
     new AlertDialog.Builder(this).setMessage("GPS 已经开启").setPositiveButton("OK", null).show();
...
class splashhandler implements Runnable {
	...
	public void run() {
		startActivity(new Intent(GetLocationActivity.this,AwesomeActivity.class));
		  initGPS();
	      isGpsOpen();
